"""This module owns the weekend history calendar screen implementation; legacy import remains temporary."""

from ..legacy import WeekendHistoryCalendarScreen as _LegacyWeekendHistoryCalendarScreen


class WeekendHistoryCalendarScreen(_LegacyWeekendHistoryCalendarScreen):
